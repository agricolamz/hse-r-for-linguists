...
\setbeamertemplate{navigation symbols}{
    ...
    \hspace{1em}%
    {{\small презентация доступна: \href{http://goo.gl/GlaOTQ}{\textbf{http://goo.gl/GlaOTQ}}}
    \hspace{4.3cm}
...
data = a[a\$s.deletion == "deleted"{},], \hfill \# данные\\
length)\hfill \# функция\\}
\begin{tabular}{rrr}
...
9 & adjective & vowell & 45 \\ 
10 & determiner & vowell & 80 \\ 
11 & noun & vowell & 376 \\ 
12 & separate morpheme & vowell & 730 \\ 
13 & verb & vowell & 16 \\ 
\end{tabular}
\end{alltt}
\normalsize
...
\end{itemize}
\vfill
Если много предикторов, то возникает желание перебрать все возможные варианты и узнать, в какой модели лучше скорректированный R², AIC и BIC. Для этого, естественно уже написаны готовые функции (см. функцию \scriptsize\verb"regsubsets"\normalsize\ в пакете \scriptsize\verb"leaps"\normalsize\ или \scriptsize\verb"bestglm"\normalsize\ в пакете \scriptsize\verb"bestglm"\normalsize). Однако многие высказывают недовольство такой стратегией выискивания лучшей из моделей, построенных на одних и тех же данных, приравнивая ее к \textbf{\textit{data fishing}}.
\end{frame}
