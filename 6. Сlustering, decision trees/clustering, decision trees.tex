...
\setbeamertemplate{navigation symbols}{
    ...
    \hspace{1em}%
    {{\small презентация доступна: \href{http://goo.gl/dqocQt}{\textbf{http://goo.gl/dqocQt}}}
    \hspace{4.3cm}
...
\normalsize
\end{frame}
\begin{frame}{Еще способы уменьшения размерностей?}
\begin{itemize}
